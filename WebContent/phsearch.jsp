                      ...
                      <div class="multiselect form-control">
					    <div class="selectBox" onclick="showCheckboxes('city_checkboxes')">
					      <select name="city_checkboxes">
					        <option id="selected_cities" value="">Παρακαλώ επιλέξτε...</option>
					      </select>
...
<!-- 	                </select> -->
	                ...
	                <div class="multiselect form-control">
					    <div class="selectBox" onclick="showCheckboxes('photocat_checkboxes')">
					      <select>
					        <option id="selected_photocats">Παρακαλώ επιλέξτε...</option>
					      </select>
					      <div class="overSelect"></div>
					    </div>
              ...
              <div class="span4">
                <div class="box aligncenter">
                 ...
                 <div class="multiselect form-control">
					    <div class="selectBox" onclick="showCheckboxes('rating_checkboxes')">
					      <select>
					        <option id="selected_ratings">Παρακαλώ επιλέξτε...</option>
					      </select>
					      <div class="overSelect"></div>
					    </div>
...
<div class="container">
  ...
  <p><span>John Doe</span> Ερασιτέχνης</p>
  <p>Κατηγορίες: Γάμος, Εκδηλώσεις</p>
</div>
